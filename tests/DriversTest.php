...
final class DriversTest extends TestCase
{
    ...
    #[Test]
    public function mysqlBuildsPdoDsnWithItsOwnLogicalDriver(): void
    {
        $driver = new MySqlDriver();

        $pdoDsn = $driver->pdoDsn(new Dsn(driver: 'mysql', host: 'localhost', database: 'app'));

        self::assertSame('mysql', $driver->name());
        self::assertSame('mysql:host=localhost;port=3306;dbname=app', $pdoDsn);
    }

    #[Test]
    public function mysqlAndMariaDbDriversDoNotAcceptEachOthersDsn(): void
    {
        $this->expectException(ConfigurationException::class);

        new MariaDbDriver()->pdoDsn(new Dsn(driver: 'mysql', host: 'localhost', database: 'app'));
    }
