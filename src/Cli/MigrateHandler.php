...
final class MigrateHandler implements HandlerInterface
{
    ...
    public function run(RunnerInterface $runner): int|Response
    {
        ...
        try {
            ...
            $this->renderException($runner, 'Ошибка миграции:', $exception);
    ...
    private function renderException(RunnerInterface $runner, string $headline, Throwable $exception): void
    {
        foreach (ThrowableFormatter::toLines($exception, $headline) as $line) {
            $runner->io()->writeln($line, 'error');
        }
    }
}
