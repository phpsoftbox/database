...
/**
 * Общая introspection схемы для MySQL-совместимых серверов.
 *
 * Реализовано через information_schema.*
 */
abstract readonly class AbstractMySqlSchemaManager implements SchemaManagerInterface
{
    ...
    public function foreignKeys(string $table): array
    {
        ...
        foreach ($rows as $row) {
            ...
            $out[] = new ForeignKeyDefinition(
                ...
                onDelete: $onDelete,
                match: null,
                name: is_string($row['constraint_name'] ?? null) ? (string) $row['constraint_name'] : null,
            );
        }
