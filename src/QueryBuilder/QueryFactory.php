...
final readonly class QueryFactory
{
     ...
     */
    public function select(array|string|Expression $columns = ['*']): SelectQueryBuilder
    {
    ...
    /**
     * Значения Expression встраиваются в UPDATE SET как явный raw SQL;
     * остальные значения передаются через bind-параметры.
     *
     * @param array<string, mixed> $data
     */
